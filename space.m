function [earningsum,dearn,wins]= space(dif)
...
for j=1:runs
    ...
    % CANGE THE NAMES PLEASE 3 average, 2 puzzlier, 3 consours
    ...
    if skillsum >= dif
        ...
        if skillsum>=(dif+10)
            moneysum= moneysum+15+wmoney1+wmoney2+wmoney3;
            dmoney= dmoney+15+wmoney1+wmoney2+wmoney3;
            ...
            if skillsum>=(dif+15)
                ...
                %more
            moneysum = moneysum+wmoney1+wmoney2+wmoney3+wmoney4+wmoney5+wmoney6;
            dmoney=dmoney+wmoney1+wmoney2+wmoney3+wmoney4+wmoney5+wmoney6;
                 end
            else 
                %statement for if the skill is less than or equal to 15
                %more
            moneysum = moneysum+wmoney7+wmoney8;
            dmoney=dmoney+wmoney7+wmoney8;
            end
        else
